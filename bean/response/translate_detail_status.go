...
//TranslateDetailStatus ***
type TranslateDetailItem struct {
	...
	Sharelurl            string   `json:"sharelUrl"`            //分享链接
...
type TranslateDetailPage struct {
...
type TranslateDetailStatus struct {
